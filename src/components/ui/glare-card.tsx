...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative isolate [aspect-ratio:17/21] w-full transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]",
        containerClassName
      )}
      ref={refElement}
      onPointerMove={(event) => {
